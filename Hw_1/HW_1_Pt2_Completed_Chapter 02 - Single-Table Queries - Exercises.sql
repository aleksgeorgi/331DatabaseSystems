...
-- Both queries count the number of orders but 
-- Query 1 give you the number of oders each employee had BEFORE may 2016
-- Query 2 gives you the total number of orders each employee had up to may 2016 but not after
-- The WHERE clause is filtering the tuples while the HAVING clause is filtering by groups
